...
~~ Source GENERAL For Supergroups 

+~~Developer By : @KNSLTHM On Telegram ,
...
git clone https://github.com/THEGENRRAL/GENERAL.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf GENERAL && rm -rf .telegram-cli && git clone https://github.com/THEGENRRAL/GENERAL.git && cd GENERAL && ./launch.sh install && ./launch.sh
~~~~~
